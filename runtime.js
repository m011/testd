( () => {
    ...
    u.O = (r, t, o, n) => {
        if (!t) {
            ...
            for (p = 0; p < e.length; p++) {
                for (var [t,o,n] = e[p], i = !0, l = 0; l < t.length; l++)
                    (!1 & n || a >= n) && Object.keys(u.O).every((e => u.O[e](t[l]))) ? t.splice(l--, 1) : (i = !1,
                    n < a && (a = n));
                if (i) {
                    e.splice(p--, 1);
                    var c = o();
    ...
    ,
    u.f = {},
    u.e = e => Promise.all(Object.keys(u.f).reduce(( (r, t) => (u.f[t](e, r),
    r)), [])),
    u.u = e => e + ".js",
    u.g = function() {
